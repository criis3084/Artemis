				...
				<template slot-scope="{data}">
					<vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
						...
						<vs-td>
							...
							<vx-tooltip text="Listado de pacientes"> <vs-button radius color="dark" type="flat" icon="list" size="large" @click="openAlert('success',data[indextr])"> </vs-button>  </vx-tooltip>
							</div>
						</vs-td>
					</vs-tr>
				</template>
